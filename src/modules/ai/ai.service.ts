...
const REPORT_PROMPT_OPTIONS: Record<AiReportType, PromptOptions> = {
  WEEKLY_REPORT: {
    ...
    customInstructions:
      '将工作内容合并整理为正式的连续编号列表(不超过5条编号).请你进行润色合并,每一条工作内容不要带任何日期,字数要求严格遵守多于40字并且少于60字,对具体项目或问题名称进行模糊化处理.',
  },
  NEXT_WEEK_PLAN: {
    templateId: 'default-next-week',
    customInstructions:
      '根据本周工作内容创建下周工作安排,将下周安排整理为正式的连续编号列表(不超过5条编号).请你进行润色合并,每一条工作安排不要带任何日期,字数要求严格遵守多于40字并且少于60字,对具体项目或问题名称进行模糊化处理.',
  },
};
